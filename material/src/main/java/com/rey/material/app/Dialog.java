...
public class Dialog extends AppCompatDialog {
    ...
    public static class Builder implements DialogFragment.Builder, Parcelable {
        ...
        protected Builder(Parcel in) {
            mStyleId = (Integer) in.readValue(Integer.class.getClassLoader());
            mContentViewId = (Integer) in.readValue(Integer.class.getClassLoader());
            mTitle = (CharSequence) in.readValue(CharSequence.class.getClassLoader());
            mPositive = (CharSequence) in.readValue(CharSequence.class.getClassLoader());
            mNegative = (CharSequence) in.readValue(CharSequence.class.getClassLoader());
            mNeutral = (CharSequence) in.readValue(CharSequence.class.getClassLoader());
